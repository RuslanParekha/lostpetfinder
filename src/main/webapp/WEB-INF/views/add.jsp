...
<div class="container">
        <form id="incedentForm" role="form" enctype="multipart/form-data" class="form-horizontal" action="${contextPath}/add" method="post" accept-charset="UTF-8">
...
<div class="panel panel-default">
    <div class="panel-footer">
        <p>
            Copyright © 2017 Lost Pet Finder by Ruslan Pareokha <a href="mailto:rakitor@gmail.com">Contact me</a>
        </p></div>
</div>
